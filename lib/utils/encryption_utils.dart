...
class EncryptionUtils {
  static const String _fixedKeyString = 'MonkeyMessengerFixedEncryptionKey123'; // 32 bytes for AES-256
  static const String _fixedIvString = 'MonkeyMsgFixedIV'; // 16 bytes for AES
  ...
  // Safe decryption specifically for display purposes
